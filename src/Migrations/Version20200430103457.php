 ...
 */
final class Version20200430103457 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ddd_menu_pizza CHANGE sprice sprice DOUBLE PRECISION DEFAULT \'NULL\', CHANGE mprice mprice DOUBLE PRECISION DEFAULT \'NULL\', CHANGE lprice lprice DOUBLE PRECISION DEFAULT \'NULL\', CHANGE papryczki papryczki TINYINT(1) NOT NULL');
        $this->addSql('ALTER TABLE ddd_menu_pizza_groups CHANGE seqbycolor seqbycolor TINYINT(1) DEFAULT \'NULL\', CHANGE kol kol INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ddd_menu_pizza_groups CHANGE seqbycolor seqbycolor TINYINT(1) DEFAULT \'NULL\', CHANGE kol kol INT DEFAULT 0 NOT NULL');
